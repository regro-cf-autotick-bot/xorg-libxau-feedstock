...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-libxau-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-libxau-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add xorg-libxau
# for installing globally
pixi global install xorg-libxau
```
...
It is possible to list all of the versions of `xorg-libxau` available on your platform:
...
```
pixi search xorg-libxau --channel conda-forge
```
